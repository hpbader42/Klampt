...
IF(WIN32)
  ...
  SET(KLAMPT_LIBRARIES debug ${KRISLIBRARY_LIBRARY_DEBUG} optimized ${KRISLIBRARY_LIBRARY_RELEASE} debug ${ODE_LIBRARY_DEBUG} optimized ${ODE_LIBRARY_RELEASE} ${GLPK_LIBRARY} debug ${TINYXML_LIBRARY_DEBUG} optimized ${TINYXML_LIBRARY_RELEASE}  opengl32 Ws2_32 winmm Gdiplus )
  SET(KLAMPT_INCLUDE_DIRS ${KRISLIBRARY_INCLUDE_DIR} ${ODE_INCLUDE_DIR} ${GLPK_INCLUDE_DIR}  ${TINYXML_INCLUDE_DIR})

  FIND_PATH(GLUT_LIB_INCLUDE ${KRISLIBRARY_ROOT}/glut32.lib)
  if(GLUT_LIB_INCLUDE)
    SET(KLAMPT_LIBRARIES ${KLAMPT_LIBRARIES} ${KRISLIBRARY_ROOT}/glut32.lib)
  else()
